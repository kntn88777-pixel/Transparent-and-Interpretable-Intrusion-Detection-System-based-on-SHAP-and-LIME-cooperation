...
SAVE_DIR = Path("XAI_Results")

N_GLOBAL = 80

# ================= TÊN FEATURE GỐC CIC17 (đã lọc) =================
ALL_COLUMNS = [
...
def run_all_models_cic17():
    ...
    for model_name in MODELS:
        ...
        for explainer_type in EXPLAINERS:
            # Skip các explainer không phù hợp
            if explainer_type == "TreeSHAP" and model_name not in ["RandomForest", "LightGBM"]:
                continue
            if explainer_type == "DeepSHAP" and model_name not in ["DNN", "CNN"]:
                continue
            ...
            try:
                ...
                shap.summary_plot(sv, X, feature_names=FEATURE_NAMES_CIC17, show=False)
